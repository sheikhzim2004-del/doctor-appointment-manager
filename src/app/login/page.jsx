            ...
            <div className='relative w-full max-w-md'>
                <div className='text-center mb-8'>
                    ...
                    <h1 className='text-4xl font-extrabold text-[#0F172A] tracking-tight'>
                        We<span className='bg-gradient-to-r from-[#0F766E] to-[#F59E0B] bg-clip-text text-transparent'>ll</span>come Back
                    </h1>
                    <p className='text-[#475569] mt-2 text-sm'>Sign in to your account to continue.</p>
                </div>
